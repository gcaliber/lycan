...
proc displayHelp*(option: string = "") =
  ...
  of "a", "i", "add", "install":
    ...
    t.write(ind2, t.yMax, true, fgWhite, "Installs an addon from a url. Supported sites are github releases, github repositories, gitlab releases, tukui, wowinterface, and curseforge. Including 'https://' is not required.\n\n")
    ...
    t.write(ind6, t.yMax, true, fgYellow, "This will install the latest commit to the master branch.", "\n")
    ...
    t.write(ind6, t.yMax, true, fgYellow, "To get this url, go the addon page and click download then copy the link for 'try again.'", "\n", resetStyle)
  ...
  of "l", "list":
    ...
    t.write(ind30, t.yMax, false, fgWhite, "Set your own <name> for addon with <id>. Must use quotes if <name> contains spaces.\n")
